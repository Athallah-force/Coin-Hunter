var scenePlay2 = new Phaser.Class({
  ...
  preload: function () {
    ...
    this.load.image("btn_play", "images/play.png");
    this.load.image("coin", "images/koin.png");
    this.load.image("enemy1", "images/musuh 1.png");
    this.load.image("enemy2", "images/musuh 2.png");
    this.load.image("enemy3", "images/musuh 3.png");
    this.load.image("coin_panel", "images/panel.png");
    this.load.image("ground", "images/tapakan.png");
    ...
    this.load.spritesheet("char", "sprite/cat.png", {
      frameWidth: 108,
      frameHeight: 94,
    });
  ...
  this.sys.game.config.width / this.background.width,
  this.sys.game.config.height / this.background.height
  );
  ...
  create: function () {
    ...
    var darkerLayer = this.add.rectangle(
      X_POSITION.CENTER,
      Y_POSITION.CENTER,
      game.canvas.width,
      game.canvas.height,
    ...
    this.anims.create({
      key: "right",
      frames: this.anims.generateFrameNumbers("char", { start: 9, end: 16 }),
      frameRate: 12,
      repeat: -1,
    });
    ...
    var newLevelTransition = function () {
      ...
      var newLevelTransitionText = activeScene.add.text(
        X_POSITION.CENTER,
        Y_POSITION.CENTER,
        "Level" + currentLevel,
        {
    ...
    var hitEnemy = function (player, enemy) {
      ...
      var gameOverImage = this.add.image(
        X_POSITION.CENTER,
      ...
      var restartButton = this.add
        .text(X_POSITION.CENTER, Y_POSITION.CENTER + 150, "Restart", {
          fontSize: "32px",
          fill: "#fff",
          backgroundColor: "#000",
          padding: { x: 20, y: 10 },
